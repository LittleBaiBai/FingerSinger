...
public class SoundManager {
	...
	public void initSounds(Context theContext, int type){
		mContext = theContext;
		...
		case 1:
			this.addSound(1, R.raw.mengmei_01); 
			this.addSound(2, R.raw.mengmei_02);  
			this.addSound(3, R.raw.mengmei_03);  
			this.addSound(4, R.raw.mengmei_04);  
			this.addSound(5, R.raw.mengmei_05);   
			this.addSound(6, R.raw.mengmei_06);   
			this.addSound(7, R.raw.mengmei_07);  
			this.addSound(8, R.raw.mengmei_08);  
			this.addSound(9, R.raw.mengmei_09);  
			this.addSound(10, R.raw.mengmei_10); 
			this.addSound(11, R.raw.mengmei_11);
			this.addSound(12, R.raw.mengmei_12);   
			this.addSound(13, R.raw.mengmei_13);   
			this.addSound(14, R.raw.mengmei_14); 
			this.addSound(15, R.raw.mengmei_15);  
			this.addSound(16, R.raw.mengmei_16);    
			this.addSound(17, R.raw.mengmei_17);  
			this.addSound(18, R.raw.mengmei_18);  
			this.addSound(19, R.raw.mengmei_19);  
			this.addSound(20, R.raw.mengmei_20);  
			this.addSound(21, R.raw.mengmei_21);  
			this.addSound(22, R.raw.mengmei_22);  
			break;
		
		case 2:
			this.addSound(1, R.raw.yujie_01); 
			this.addSound(2, R.raw.yujie_02);  
			this.addSound(3, R.raw.yujie_03);  
			this.addSound(4, R.raw.yujie_04);  
			this.addSound(5, R.raw.yujie_05);   
			this.addSound(6, R.raw.yujie_06);   
			this.addSound(7, R.raw.yujie_07);  
			this.addSound(8, R.raw.yujie_08);  
			this.addSound(9, R.raw.yujie_09);  
			this.addSound(10, R.raw.yujie_10); 
			this.addSound(11, R.raw.yujie_11);
			this.addSound(12, R.raw.yujie_12);   
			this.addSound(13, R.raw.yujie_13);   
			this.addSound(14, R.raw.yujie_14); 
			this.addSound(15, R.raw.yujie_15);  
			this.addSound(16, R.raw.yujie_16);    
			this.addSound(17, R.raw.yujie_17);  
			this.addSound(18, R.raw.yujie_18);  
			this.addSound(19, R.raw.yujie_19);  
			this.addSound(20, R.raw.yujie_20);  
			this.addSound(21, R.raw.yujie_21);  
			this.addSound(22, R.raw.yujie_22); 		
			break;
			
		case 3:
			this.addSound(1, R.raw.niangshou_01); 
			this.addSound(2, R.raw.niangshou_02);  
			this.addSound(3, R.raw.niangshou_03);  
			this.addSound(4, R.raw.niangshou_04);  
			this.addSound(5, R.raw.niangshou_05);   
			this.addSound(6, R.raw.niangshou_06);   
			this.addSound(7, R.raw.niangshou_07);  
			this.addSound(8, R.raw.niangshou_08);  
			this.addSound(9, R.raw.niangshou_09);  
			this.addSound(10, R.raw.niangshou_10); 
			this.addSound(11, R.raw.niangshou_11);
			this.addSound(12, R.raw.niangshou_12);   
			this.addSound(13, R.raw.niangshou_13);   
			this.addSound(14, R.raw.niangshou_14); 
			this.addSound(15, R.raw.niangshou_15);  
			this.addSound(16, R.raw.niangshou_16);    
			this.addSound(17, R.raw.niangshou_17);  
			this.addSound(18, R.raw.niangshou_18);  
			this.addSound(19, R.raw.niangshou_19);  
			this.addSound(20, R.raw.niangshou_20);  
			this.addSound(21, R.raw.niangshou_21);  
			this.addSound(22, R.raw.niangshou_22);	
			break;

		case 4:
			this.addSound(1, R.raw.hanzi_01); 
			this.addSound(2, R.raw.hanzi_02);  
			this.addSound(3, R.raw.hanzi_03);  
			this.addSound(4, R.raw.hanzi_04);  
			this.addSound(5, R.raw.hanzi_05);   
			this.addSound(6, R.raw.hanzi_06);   
			this.addSound(7, R.raw.hanzi_07);  
			this.addSound(8, R.raw.hanzi_08);  
			this.addSound(9, R.raw.hanzi_09);  
			this.addSound(10, R.raw.hanzi_10); 
			this.addSound(11, R.raw.hanzi_11);
			this.addSound(12, R.raw.hanzi_12);   
			this.addSound(13, R.raw.hanzi_13);   
			this.addSound(14, R.raw.hanzi_14); 
			this.addSound(15, R.raw.hanzi_15);  
			this.addSound(16, R.raw.hanzi_16);    
			this.addSound(17, R.raw.hanzi_17);  
			this.addSound(18, R.raw.hanzi_18);  
			this.addSound(19, R.raw.hanzi_19);  
			this.addSound(20, R.raw.hanzi_20);  
			this.addSound(21, R.raw.hanzi_21);  
			this.addSound(22, R.raw.hanzi_22); 
			break;
//		case 1:
